...
2. Download and install the CData JDBC Driver for {source}: [https://www.cdata.com/drivers/salesforce/download/jdbc](https://www.cdata.com/drivers/salesforce/download/jdbc/)
